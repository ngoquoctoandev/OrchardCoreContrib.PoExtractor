...
public class SingularStringExtractor : LocalizableStringExtractor<SyntaxNode>
{
    ...
    public override bool TryExtract(SyntaxNode node, out LocalizableStringOccurence? result)
    {
        ...
        if (node is InvocationExpressionSyntax { Expression: IdentifierNameSyntax identifierName } accessor &&
            ...
            accessor.ArgumentList != null)
        {
            ...
            if (argument?.GetExpression() is LiteralExpressionSyntax literal && literal.IsKind(SyntaxKind.StringLiteralExpression))
            {
