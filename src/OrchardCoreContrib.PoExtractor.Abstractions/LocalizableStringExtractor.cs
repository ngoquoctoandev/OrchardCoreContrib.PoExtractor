...
public abstract class LocalizableStringExtractor<TNode> : IStringExtractor<TNode>
{
    ...
    public LocalizableStringExtractor(IMetadataProvider<TNode> metadataProvider) => MetadataProvider = metadataProvider ?? throw new ArgumentNullException(nameof(metadataProvider));
